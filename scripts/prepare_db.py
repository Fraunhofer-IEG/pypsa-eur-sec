...
#n0 = pypsa.Network(os.path.join(network_path,\
                # "elec_s_256_lv1__Co2L0-720H-T-H-B-I-solar1-dist1_2030.nc"))
...
def add_storage(tech, carrier, reg=False):
    global db
    if not reg:
...
tech_colors={
    ...
    'residential rural ground heat pump':'salmon',
    'services rural ground heat pump':'salmon',
    'ac':'y',
    'industry electricity': '#E6DAA6'}    